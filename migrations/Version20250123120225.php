 ...
 */
final class Version20250123120225 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ALP_TEST (TST_START_DATE DATETIME NOT NULL, TST_END_DATE DATETIME NOT NULL, TST_SUCCESS TINYINT(1) DEFAULT NULL, CHG_ID INT NOT NULL, PRIMARY KEY(CHG_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
