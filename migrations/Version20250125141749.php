 ...
 */
final class Version20250125141749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ALP_EVENT (EVT_ID INT AUTO_INCREMENT NOT NULL, EVT_TITLE VARCHAR(50) NOT NULL, EVT_DESCRIPTION VARCHAR(255) NOT NULL, EVT_IMAGE VARCHAR(100) NOT NULL, EVT_START_DATE DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', EVT_END_DATE DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', USR_ID INT DEFAULT NULL, INDEX IDX_8507B8D7C4DC529D (USR_ID), PRIMARY KEY(EVT_ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
