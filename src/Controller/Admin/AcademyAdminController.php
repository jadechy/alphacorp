...
use App\Form\Admin\AcademyAdminType;
...
final class AcademyAdminController extends AbstractController
{
    ...
    {
        $academy = new Academy();
        $form = $this->createForm(AcademyAdminType::class, $academy);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_academy_index', [], Response::HTTP_SEE_OTHER);
        }
